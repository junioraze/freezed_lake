...
class LakehouseWorker:
    ...
    Centraliza autenticação, carregamento de catálogo e operações DDL/DML básicas.
    """
    
    def __init__(self):
        # Lê as variáveis uma única vez na instância
    ...
    def create_namespace_if_not_exists(self, namespace: str):
        ...
        try:
            ...
            logger.info(f"Namespace '{namespace}' criado.")
    ...
    def create_table_if_not_exists(self, table_identifier: str, schema, partition_spec, 
        ...
        try:
            ...
            if "Credential vending was requested" not in str(e):
                logger.error(f"Falha crítica ao criar tabela: {e}")
                raise
            return catalog.load_table(table_identifier)